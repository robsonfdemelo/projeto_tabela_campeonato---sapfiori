		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#campeonatobrasileiro-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"campeonatobrasileiro-display": {
								"semanticObject": "campeonatobrasileiro",
								"action": "display",
								"description": "Projeto de Estudo com SAP Fiori",
								"title": "Campeonato Brasileiro 2023",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=campeonatobrasileiro",
									"url": sap.ui.require.toUrl("campeonatobrasileiro")
								}
							}
						}
					}
